...
sf::Vector2f Player::getPosition() { return player.getPosition(); }
...
void Player::setSpriteRotation(float r) { playerSprite.setRotation(r); }

bool Player::getTouchingGround() { return touchingGround; }
