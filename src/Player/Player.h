...
public:
  ...
  bool collidesWithTower(const Tower &tower)
      const; // Returns wether player is colliding with any towers
  bool collidesWithCollider(const Collider &collider)
      const; // Returns wether player is colliding with any colliders
};
