...
float Tower::getHeight() { return towerHeight; }

float Tower::getWidth() { return towerWidth; }

sf::Vector2f Tower::getPosition() { return tower.getPosition(); }

sf::FloatRect Tower::getBoundingBox() const { return tower.getGlobalBounds(); }
